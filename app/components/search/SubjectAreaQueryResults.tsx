...
const SubjectAreaQueryResults = forwardRef<
  HTMLUListElement,
  SubjectAreaQueryResultsProps
>(
  (
    { courses, query, onSelectSubjectArea }: SubjectAreaQueryResultsProps,
    ref,
  ) => {
...
SubjectAreaQueryResults.displayName = "SubjectAreaQueryResults";
