...
import { CatalogNumberQueryResults, matchCourse } from "@/app/components/search/CatalogNumberQueryResults";
...
import { getSubjectAreaLongName, matchInstructor, matchSubjectArea } from "@/app/utils";
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-2">
                {isSearchingByInstructor ? (
                    <Input
                        ...
                        onKeyDown={(e) => {
                            if (e.key === "Enter" && instructorQuery !== "" && selectedInstructor === "") {
                    ...
                    <Input
                        ...
                        onKeyDown={(e) => {
                            if (e.key === "Enter" && subjectAreaQuery !== "" && selectedSubjectArea === "") {
                    ...
                    <input
                        ...
                        onKeyDown={(e) => {
                            ...
                            if (e.key === "Enter" && catalogNumberQuery !== "") {
                                ...
                                const matchingAreas = Object.values(courses[selectedSubjectArea] ?? {})
                                    .map((area) => ({ area, result: matcher(area) }))
                                    .filter(({ result }) => result.matches)
                                    .sort((a, b) => b.result.score - a.result.score);
                                ...
                                if (matchingAreas.length > 0) {
                                    ...
                                    router.push(`/${selectedSubjectArea}/${selectedCourse.catalogNumber}`);
                                }
                            }
                        }}
                    />
