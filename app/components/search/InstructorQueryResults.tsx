...
const InstructorQueryResults = ({ instructors, query, onSelectInstructor }: InstructorQueryResultsProps) => {
                    ...
                    <div className="text-black bg-white cursor-pointer p-4 border-t-gray-200 border-t-2">
                        <div className="flex">
                            <div className="flex-1">
                                <h3 className="text-2xl font-bold">{instructorName.split(", ").toReversed().join(" ")}</h3>
